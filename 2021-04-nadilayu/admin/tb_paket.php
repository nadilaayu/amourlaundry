...
if (isset($_POST['add-acun'])) {
  ...
  $harga = $_POST['harga'];
  if ($id_outlet != '' && $jenis != '') {
    $_add = $koneksi->query("INSERT INTO tb_paket VALUES ('','$id_outlet','$jenis','$nama_paket','$harga')");
  }
}
...
<script>
  function checkForm() {
    ...
    var id_paket = document.getElementById("id_paket1").value;
    ...
    if (id_paket == '' || id_outlet == '' || jenis == '' || nama_paket == '' || harga == '') {
